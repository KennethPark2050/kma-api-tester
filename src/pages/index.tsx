// src/pages/index.tsx (모바일 스타일 개선 최종본)
import { useState } from 'react';

// STATIONS 데이터 및 인터페이스/컴포넌트 정의 (변경 없음)
    ...
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4">
              <div className="flex-grow">
                ...
                <input
                  ...
                  className="appearance-none mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3 text-base focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="w-full sm:w-48">
                 ...
                 <select
                   ...
                   className="appearance-none mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3 text-base bg-white focus:border-blue-500 focus:ring-blue-500"
                 >
          ...
          {/* --- 마지막 요청 정보 가독성 개선 --- */}
          {lastRequestParams && !loading && (
            <div className="mb-8 p-4 bg-slate-100 border border-slate-300 rounded-lg shadow-sm">
              <h3 className="font-semibold text-slate-800">마지막 요청 정보:</h3>
              <div className="mt-2 flex flex-wrap gap-x-6 gap-y-2 text-sm">
                <p><strong>time:</strong> <span className="font-mono bg-slate-200 text-slate-800 px-2 py-1 rounded">{lastRequestParams.time}</span></p>
                <p><strong>stn:</strong> <span className="font-mono bg-slate-200 text-slate-800 px-2 py-1 rounded">{lastRequestParams.stn}</span></p>
                <p><strong>help:</strong> <span className="font-mono bg-slate-200 text-slate-800 px-2 py-1 rounded">{lastRequestParams.help}</span></p>
              </div>
            </div>
          )}
